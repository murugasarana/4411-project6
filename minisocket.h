...
#define SOCKET_CLIENT_MAX 32767 
#define SOCKET_SERVER_MAX 65535
#define MAX_TRIES 6
...
int minisocket_append_alarm_id(minisocket_t socket, void* item);

void* minisocket_dequeue_alarm_id(minisocket_t socket);
