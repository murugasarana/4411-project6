...
#define UNBOUND_MIN 0
#define UNBOUND_MAX 32767
#define BOUND_MIN 32768
#define BOUND_MAX 65535
...
extern int miniport_unbound_enqueue(miniport_t port, network_interrupt_arg_t *data);
